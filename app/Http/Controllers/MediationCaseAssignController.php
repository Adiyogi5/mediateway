...
class MediationCaseAssignController extends Controller
{
    ...
    public function index(Request $request): View|JsonResponse
    {
        ...
        return view('mediation_caseassign.index', compact('casemanagers', 'mediators'));
    }
    ...
    public function bulkAssign(Request $request)
    {
        $request->validate([
            ...
            'mediator_id' => 'required|exists:drps,id',
        ]);
        ...
        return redirect()->route('mediation_caseassign')->with('success', 'All unassigned cases assigned successfully.');
    }
