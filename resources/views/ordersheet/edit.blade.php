...
@section('content')
    <div class="card mb-3">
        <div class="card-header">
            <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                    <h5 class="mb-0" data-anchor="data-anchor">Order Sheet :: Order Sheet Edit </h5>
                </div>
                <div class="col-auto d-flex item-align-self ms-auto">
                    ...
                    <div class="nav nav-pills nav-pills-falcon flex-grow-1 my-auto ms-2" role="tablist">
                        <a href="{{ route('ordersheet') }}" class="btn btn-outline-secondary">
        ...
        <div class="card-body">
            <form class="row" id="edit" method="POST" action="{{ route('ordersheet.edit', $orderSheet['id']) }}"
                ...
                <div class="row">
                    <div class="col-md-6 mt-2">
                        <div class="form-group">
                            ...
                            <select name="drp_type" class="form-select" id="drp_type">
                                ...
                                <option value="1" {{ old('drp_type', $orderSheet->drp_type) == 1 ? 'selected' : '' }}>Arbitrator</option>
                                <option value="4" {{ old('drp_type', $orderSheet->drp_type) == 4 ? 'selected' : '' }}>Mediator</option>
                                <option value="5" {{ old('drp_type', $orderSheet->drp_type) == 5 ? 'selected' : '' }}>Conciliator</option>
                            </select>                            
                                @error('drp_type')
                    ...
                    <div class="col-md-6 mt-2">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" value="{{ old('name', $orderSheet['name']) }}"
                    ...
                    <div class="col-md-6 mt-2">
                        <div class="form-group">
                            ...
                            <input type="text" name="subject" class="form-control" value="{{ old('subject', $orderSheet['subject']) }}"
                ...
                <div class="row">
                    <div class="col-md-12 mt-2">
                        <div class="form-group">
                            ...
                            <textarea id="email_content" name="email_content" class="form-control" id="email_content">{{ old('email_content', $orderSheet['email_content']) }}</textarea>
                            @error('email_content')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="row">
                    <div class="col-md-12 mt-2">
                        <div class="form-group">
                            <label class="form-label" for="notice_format">Order Sheet Format <span class="required">*</span></label>
                            <textarea class="form-control" id="notice_format" name="notice_format">{{ old('notice_format', $orderSheet['notice_format']) }}</textarea>
                            @error('notice_format')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="modal-dialog modal-xl">
                            <div class="modal-content">
                                <div class="modal-header text-center justify-content-center">
                                    <h4 class="modal-title text-dark fw-bold">Variable for Order Sheet</h4>
                                </div>
...
<script>
    $(document).on("click", "[data-bs-target='#myModal']", function () {
        $.ajax({
            url: "{{ route('getordersheetVariables') }}", // Correct for OrderSheet
            type: "GET",
