...
<div class="card mb-3">
    <div class="card-header">
        <div class="row flex-between-end">
            <div class="col-auto align-self-center">
                <h5 class="mb-0" data-anchor="data-anchor">Blog :: Blog Edit </h5>
            </div>
    ...
    <div class="card-body">
        <form class="row" id="ediUser" method="POST" action="{{ route('blogs.edit', $blogs['id']) }}"
            ...
            <div class="col-lg-6 mt-2">
                ...
                <input class="form-control" id="post_by" placeholder="Post By" name="post_by" type="text"
                    value="{{ old('post_by', $blogs['post_by']) }}" />
                @error('post_by')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="col-lg-6 mt-2">
                ...
                <select name="status" class="form-select" id="status">
                    <option value="1" @selected(old('status', $blogs['status'])==1)> Active </option>
                    <option value="0" @selected(old('status', $blogs['status'])==0)> Inactive </option>
                </select>
                @error('status')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
            ...
            <div class="col-lg-6 mt-2">
                ...
                <div class="img-group mb-2">
                    <img class="" src="{{ asset('storage/' . $blogs['image']) }}" alt="">
                </div>
            ...
            <div class="col-lg-12 mt-2">
                ...
                <textarea class="form-control" id="short_description" name="short_description">{{ $blogs['short_description'] }}</textarea>
