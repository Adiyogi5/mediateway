...
<div class="card mb-3">
    <div class="card-header">
        <div class="row flex-between-end">
            <div class="col-auto align-self-center">
                <h5 class="mb-0" data-anchor="data-anchor">Clients :: Client Edit </h5>
            </div>
    ...
    <div class="card-body">
        <form class="row" id="ediUser" method="POST" action="{{ route('clients.edit', $client['id']) }}"
            ...
            <div class="col-lg-6 mt-2">
                ...
                <div class="img-group mb-2">
                    <img class="" src="{{ asset('storage/' . $client['image']) }}" alt="">
                </div>
            </div>
            ...
            <div class="col-lg-6 mt-2">
                ...
                <select name="status" class="form-select" id="status">
                    <option value="1" @selected(old('status', $client['status'])==1)> Active </option>
                    <option value="0" @selected(old('status', $client['status'])==0)> Inactive </option>
                </select>
                @error('status')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
