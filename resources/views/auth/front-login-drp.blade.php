    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card my-0 my-lg-5">
                <div class="card-body">
                    <h2>Sign In as <span class="text-secondary">Drp</span></h2>
                    <p>Enter your mobile and OTP to login</p>

                    <form method="POST" action="{{ route('login.post', ['guard' => 'drp']) }}">
                        @csrf
                        <input type="hidden" name="login_as" value="drp">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7 col-6">
                                <input type="text" placeholder="OTP Code" name="otp"
                                    id="otp-drp" class="form-control @error('otp') is-invalid @enderror">
                                @error('otp')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-12 p-3">
                                <div class="form-check form-check-primary form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="remember"
                                        id="remember-drp" checked="checked" />
                                    <label class="form-check-label" for="remember-drp">Remember me</label>
                                </div>
                            </div>
                            ...
                            {{-- <div class="col-6 text-end">
                                @if (Route::has('forget.password'))
                                    <a class="text-second" href="{{ route('forget.password', 'drp') }}">
                                        Forgot Password?
                                    </a>
                                @endif
                            </div> --}}
