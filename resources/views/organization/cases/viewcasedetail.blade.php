                                                            ...
                                                            <table class="table custom-table">
                                                                ...
                                                                <tbody>
                                                                    @if ($case->notices->isNotEmpty())
                                                                        @foreach ($case->notices->filter(fn($n) => $n->notice_type >= 1 && $n->notice_type <= 10 && \Carbon\Carbon::parse($n->notice_date)->greaterThanOrEqualTo(\Carbon\Carbon::today()))->sortBy('notice_type') as $notice)
                                                                            <tr>
