...
@section('content')
    <div class="card mb-3">
            ...
            <div class="row flex-between-end">
                ...
                <div class="col-auto d-flex item-align-self ms-auto">
                    ...
                    <div class="nav nav-pills nav-pills-falcon flex-grow-1 my-auto ms-2" role="tablist">
                        <a href="{{ route('award') }}" class="btn btn-outline-secondary">
        ...
        <div class="card-body">
            <form class="row" id="edit" method="POST" action="{{ route('award.edit', $award['id']) }}"
                    ...
                    <div class="col-md-6 mt-2">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control"
                                value="{{ old('name', $award['name']) }}" id="name" placeholder="Enter Name">
                            @error('name')
                    ...
                    <div class="col-md-6 mt-2">
                        <div class="form-group">
                            ...
                            <input type="text" name="subject" class="form-control"
                                value="{{ old('subject', $award['subject']) }}" id="subject" placeholder="Enter Subject">
                            @error('subject')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                ...
                <div class="row">
                    <div class="col-md-12 mt-2">
                        <div class="form-group">
                            ...
                            <textarea id="email_content" name="email_content" class="form-control" id="email_content">{{ old('email_content', $award['email_content']) }}</textarea>
                            @error('email_content')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-md-12 mt-2">
                        <div class="form-group">
                            <label class="form-label" for="notice_format">Award Format <span
                                    class="required">*</span></label>
                            <textarea class="form-control" id="notice_format" name="notice_format">{{ old('notice_format', $award['notice_format']) }}</textarea>
                            @error('notice_format')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="modal-dialog modal-xl">
                            <div class="modal-content">
                                <div class="modal-header text-center justify-content-center">
                                    <h4 class="modal-title text-dark fw-bold">Variable For Award</h4>
                                </div>
...
@section('js')
    ...
    <script>
        $(document).on("click", "[data-bs-target='#myModal']", function() {
            $.ajax({
                url: "{{ route('getawardVariables') }}", // Correct for OrderSheet
                type: "GET",
