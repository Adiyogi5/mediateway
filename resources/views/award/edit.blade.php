        ...
        <div class="card-body">
            <form class="row" id="edit" method="POST" action="{{ route('award.edit', $award['id']) }}"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mt-2">
                        <div class="form-group">
                            ...
                            <input type="text" name="subject" class="form-control" value="{{ old('subject', $award['subject']) }}"
                ...
                <div class="row">
                    <div class="col-md-12 mt-2">
                        <div class="form-group">
                            <label class="form-label" for="notice_format">Award Format <span class="required">*</span></label>
...
<script>
   $(document).on("click", "[data-bs-target='#myModal']", function () {
        $.ajax({
            url: "{{ route('getawardVariables') }}", // Correct for Award
            type: "GET",
