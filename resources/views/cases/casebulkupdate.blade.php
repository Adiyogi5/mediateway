...
@section('content')
    <div class="card mb-3">
        ...
        <div class="card-body form-validate">
            ...
            <div class="col-12 col-md-12 my-4 p-lg-3 p-2 border border-2 d-flex justify-content-between item-align-self">
                <div class="my-auto">
                ...
                <div>
                    <a href="{{ route('cases.casebulkupdate.sample') }}" class="btn btn-warning py-1">Download</a>
                </div>
            </div>
            ...
            <div class="col-12 col-md-12 mt-5 p-lg-3 p-2 border border-2 d-grid item-align-self">
                ...
                <form id="submitfileCases" action="{{ route('cases.casebulkupdate.import') }}" method="POST"
