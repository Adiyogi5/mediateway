        ...
        <div class="card-header">
            <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                    <h5 class="mb-0" data-anchor="data-anchor">Settlement Agreements :: Settlement Agreement Edit </h5>
                </div>
                    ...
                    <div class="col-md-6 mt-2">
                        <div class="form-group">
                            ...
                            <select name="drp_type" class="form-select" id="drp_type">
                                ...
                                <option value="4"
                                    {{ old('drp_type', $settlementletter->drp_type) == 4 ? 'selected' : '' }}>Mediator
                                </option>
                                <option value="5"
                                    {{ old('drp_type', $settlementletter->drp_type) == 5 ? 'selected' : '' }}>Conciliator
                                </option>
                            </select>
                            @error('drp_type')
