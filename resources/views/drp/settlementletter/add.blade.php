        ...
        <div class="row">
            ...
            <div class="col-md-9 col-12">
                <div class="card mb-3 card-inner">
                    <div class="card-header">
                        <div class="row flex-between-end">
                            <div class="col-auto align-self-center">
                                <h5 class="mb-0" data-anchor="data-anchor">Settlement Agreements :: Add </h5>
                            </div>
                    ...
                    <div class="card-body">
                        <form class="row" id="add" method="POST" action="{{ route('drp.settlementletter.add') }}"
...
@section('js')
    ...
    <script>
        $(document).on("click", "[data-bs-target='#myModal']", function() {
            $.ajax({
                url: "{{ route('drp.getsettlementletterVariables') }}", // Correct for settlementletter
                type: "GET",
