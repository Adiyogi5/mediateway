                ...
                <div class="card mb-3 card-inner">
                    <div class="card-header">
                        <div class="row flex-between-end">
                            <div class="col-auto align-self-center">
                                <h5 class="mb-0" data-anchor="data-anchor">Case Order Sheets :: Edit </h5>
                            </div>
                            <div class="col-auto d-flex item-align-self ms-auto">
                                ...
                                <div class="nav nav-pills nav-pills-falcon flex-grow-1 my-auto ms-2" role="tablist">
                                    <a href="{{ route('drp.ordersheet') }}" class="btn btn-outline-secondary">
                    ...
                    <div class="card-body">
                        <form class="row" id="edit" method="POST"
                            action="{{ route('drp.ordersheet.edit', $orderSheet['id']) }}" enctype='multipart/form-data'>
                            @csrf
                            <div class="row">
                                <div class="col-md-6 mt-2">
                                    <div class="form-group">
                                        ...
                                        <select name="drp_type" class="form-select" id="drp_type">
                                            @if ($drp->drp_type == 1)
                                                <option value="1" {{ old('drp_type', $orderSheet->drp_type) == 1 ? 'selected' : '' }}>
                                                    Arbitrator
                                                </option>
                                            @elseif ($drp->drp_type == 4)
                                                <option value="4" {{ old('drp_type', $orderSheet->drp_type) == 4 ? 'selected' : '' }}>
                                                    Mediator
                                                </option>
                                            @elseif ($drp->drp_type == 5)
                                                <option value="5" {{ old('drp_type', $orderSheet->drp_type) == 5 ? 'selected' : '' }}>
                                                    Conciliator
                                                </option>
                                            @endif
                                        </select>
                                ...
                                <div class="col-md-6 mt-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control"
                                            value="{{ old('name', $orderSheet['name']) }}" id="name"
                                ...
                                <div class="col-md-6 mt-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="subject" class="form-control"
                                            value="{{ old('subject', $orderSheet['subject']) }}" id="subject"
                            ...
                            <div class="row">
                                <div class="col-md-12 mt-2">
                                    <div class="form-group">
                                        <label class="form-label" for="notice_format">Order Sheet Format <span
                                                class="required">*</span></label>
...
@section('js')
    ...
    <script>
        $(document).on("click", "[data-bs-target='#myModal']", function() {
            $.ajax({
                url: "{{ route('drp.getordersheetVariables') }}", // Correct for OrderSheet
                type: "GET",
