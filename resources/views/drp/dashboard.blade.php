                ...
                <div class="col-md-9 col-12">
                    <div class="card-inner card-dashboard">
                        ...
                        @foreach($drps as $drp)
                            ...
                            @elseif($drp->approve_status == 2)
                                <div class="text-danger text-center py-5">Your Account has been Rejected. Please Contact to MediateWay ADR Centre.</div>
                            @else
                                <div>
                                    <h5>Welcome.....</h5>
                                    <div class="text-warning text-center py-5">Your Account approval is Pending.</div>
                                </div>
                            @endif
                        @endforeach
                    </div>
