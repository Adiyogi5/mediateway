                ...
                <div class="card mb-3 card-inner">
                    <div class="card-header">
                        <div class="row flex-between-end">
                            <div class="col-auto align-self-center">
                                <h5 class="mb-0" data-anchor="data-anchor">Awards :: Edit </h5>
                            </div>
                    ...
                    <div class="card-body">
                        <form class="row" id="edit" method="POST"
                            action="{{ route('drp.award.edit', $award['id']) }}" enctype='multipart/form-data'>
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
                                    <!-- Modal -->
                                ...
                                <div class="col-md-6 mt-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control"
                                            value="{{ old('name', $award['name']) }}" id="name"
                                ...
                                <div class="col-md-6 mt-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="subject" class="form-control"
                                            value="{{ old('subject', $award['subject']) }}" id="subject"
