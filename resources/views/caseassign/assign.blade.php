                ...
                <div class="col-auto ms-auto">
                    <div class="nav nav-pills nav-pills-falcon">
                        @if (Helper::userCan(111, 'can_edit'))
                            <a href="{{ route('caseassign') }}" class="btn btn-outline-secondary">
            ...
            <div class="col-md-6 mb-3">
                <ul class="list-group">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        ...
                        @php
                            $addressTypeClaimant = $caseData['claimant_address_type'] == 1 ? 'Home' : 'Office';
                        @endphp
                        <span class="">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        ...
                        @php
                            $addressTypeRespondent = $caseData['respondent_address_type'] == 1 ? 'Home' : 'Office';
                        @endphp
                        <span class="">
                ...
                <div class="col-lg-6 mt-2">
                    ...
                    <select name="case_manager_id" class="form-select" id="case_manager_id">
                        ...
                        @foreach ($casemanagers as $casemanager)
                            <option value="{{ $casemanager->id }}" 
                                @selected(old('case_manager_id', $assignCase?->case_manager_id) == $casemanager->id)>
                                {{ $casemanager->name }}
                            </option>                        
                        @endforeach
                    </select>                    
                    ...
                    <select name="mediator_id" class="form-select" id="mediator_id">
                        ...
                        @foreach ($mediators as $mediator)
                            <option value="{{ $mediator->id }}" 
                                @selected(old('mediator_id', $assignCase?->mediator_id) == $mediator->id)>
                                {{ $mediator->name }}
                            </option>                        
                        @endforeach
                    </select>                    
                ...
                <div class="col-lg-6 mt-2">
                    ...
                    <select name="conciliator_id" class="form-select" id="conciliator_id">
                        ...
                        @foreach ($conciliators as $conciliator)
                            <option value="{{ $conciliator->id }}" 
                                @selected(old('conciliator_id', $assignCase?->conciliator_id) == $conciliator->id)>
                                {{ $conciliator->name }}
                            </option>                        
                        @endforeach
                    </select>                    
